...
# Enable FastF1 cache
fastf1.Cache.enable_cache('/Users/shriranjanpatil/Data/VS_Code/BigData/f1-telemetry-pipeline/f1_cache')
...
def get_lap_data():
    session = fastf1.get_session(2025, 'Chinese Grand Prix', 'R')
    session.load()
    laps = session.laps
